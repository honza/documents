...
\section*{Problems with Google Sites}
    ...
    \subsection*{Proprietary technology}
        ...
        the solution will exist in the future. Google is known for periodically
        deprecating their
        APIs\footnote{http://googlecode.blogspot.com/2011/05/spring-cleaning-for-some-of-our-apis.html}.
        ...
        deprecated today, SheepDogInc developers would be force spend
    ...
    \subsection*{Limited customizability}
        ...
        If SheepDogInc is interested in branding their product in any way, the
        use of Google Sites should be discouraged.
    ...
    \subsection*{Professionalism}
        ...
        unprofessional to Internet-savvy users and potential customer.
